...
text4.place (x = 300, y = 10)
checkbox1.place (x = 10, y = 140)
checkbox2.place (x = 10, y = 160)
checkbox3.place (x = 10, y = 180)
button2.place (x = 150, y = 28)
label1.place (x = 10, y = 70)
entry_locate.place (x = 10, y = 30)
entry_filename.place (x = 10, y = 120)
